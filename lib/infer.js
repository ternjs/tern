...
(function(mod) {
  ...
  AVal.prototype = extend(ANull, {
    ...
    makeupType: function() {
      if (this.propertyOf && this.propertyOf.hasProp("<i>")) {
        var computedProp = this.propertyOf.getProp("<i>"), computedType;
        if (computedProp != this && (computedType = computedProp.getType()))
          return computedType;
      }
