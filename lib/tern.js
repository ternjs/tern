...
(function(root, mod) {
  ...
  function analyzeAll(srv, timeBudget, c) {
    ...
    if (e) { srv.fetchError = null; return c && c(e); }
  ...
  function resetServer(srv, query) {
    if (query.forgetFiles) while (srv.files.length) srv.delFile(srv.files[0])
    srv.reset()
    setTimeout(function() {analyzeAll(srv)}, 50)
  }
