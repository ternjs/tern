...
(function(mod) {
  ...
  function isSimpleInstance(o, state) {
    ...
    if (o.proto && o.proto != state.cx.protos.Object && o.proto.isProtoOf &&
        !o.isProtoOf && o.proto.isProtoOf.path) {
      desc(o.proto, state);
      o._fromProto = true;
  ...
  infer.Obj.prototype.getDesc = function(state) {
    if (isSimpleInstance(this, state)) return "+" + this.proto.isProtoOf.path;
