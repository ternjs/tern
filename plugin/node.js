    ...
    node: {
      ...
      stream: {
        ...
        prototype: {
          ...
          pipe: {
            "!type": "fn(destination: +node.stream.Writable, options?: ?)",
        ...
        Readable: {
          ...
          prototype: {
            ...
            destroy: "fn()",
            unpipe: {
              "!type": "fn(dest?: +node.stream.Writable)",
            ...
            wrap: {
              "!type": "fn(stream: ?) -> +node.stream.Readable",
      ...
      http: {
        STATUS_CODES: {},
        createServer: {
          "!type": "fn(listener?: fn(request: +node.http.IncomingMessage, response: +node.http.ServerResponse)) -> +node.http.Server",
        ...
        request: {
          "!type": "fn(options: ?, callback?: fn(res: +node.http.IncomingMessage)) -> +node.http.ClientRequest",
      ...
      https: {
        ...
        createServer: {
          "!type": "fn(listener?: fn(request: +node.http.IncomingMessage, response: +node.http.ServerResponse)) -> +node.https.Server",
      ...
      cluster: {
        ...
        Worker: {
          ...
          prototype: {
            ...
            process: {
              "!type": "+node.child_process.ChildProcess",
        ...
        setupMaster: {
          "!type": "fn(settings?: node.cluster.settings)",
        ...
        fork: {
          "!type": "fn(env?: ?) -> +node.cluster.Worker",
      ...
      zlib: {
        ...
        createGzip: {
          "!type": "fn(options: ?) -> +node.zlib.Gzip",
        ...
        createGunzip: {
          "!type": "fn(options: ?) -> +node.zlib.Gunzip",
        ...
        createDeflate: {
          "!type": "fn(options: ?) -> +node.zlib.Deflate",
        ...
        createInflate: {
          "!type": "fn(options: ?) -> +node.zlib.Inflate",
        ...
        createInflateRaw: {
          "!type": "fn(options: ?) -> +node.zlib.InflateRaw",
        ...
        createDeflateRaw: {
          "!type": "fn(options: ?) -> +node.zlib.DeflateRaw",
        ...
        createUnzip: {
          "!type": "fn(options: ?) -> +node.zlib.Unzip",
      ...
      readline: {
        createInterface: {
          "!type": "fn(options: ?) -> +node.readline.Interface",
      ...
      vm: {
        ...
        createScript: {
          "!type": "fn(code: string, filename?: string) -> +node.vm.Script",
      ...
      child_process: {
        ...
        spawn: {
          "!type": "fn(command: string, args?: [string], options?: ?) -> +node.child_process.ChildProcess",
        ...
        exec: {
          "!type": "fn(command: string, callback: fn(error: ?, stdout: +Buffer, stderr: +Buffer)) -> +node.child_process.ChildProcess",
        ...
        execFile: {
          "!type": "fn(file: string, args: [string], options: ?, callback: fn(error: ?, stdout: +Buffer, stderr: +Buffer)) -> +node.child_process.ChildProcess",
        ...
        fork: {
          "!type": "fn(modulePath: string, args?: [string], options?: ?) -> +node.child_process.ChildProcess",
      ...
      net: {
        createServer: {
          "!type": "fn(options?: ?, connectionListener?: fn(socket: +node.net.Socket)) -> +node.net.Server",
        ...
        connect: {
          "!type": "fn(options: ?, connectionListener?: fn()) -> +node.net.Socket",
      ...
      dgram: {
        createSocket: {
          "!type": "fn(type: string, callback?: fn()) -> +node.dgram.Socket",
      ...
      fs: {
        ...
        stat: {
          "!type": "fn(path: string, callback?: fn(err: +Error, stats: +node.fs.Stats) -> ?) -> +node.fs.Stats",
        ...
        fstat: {
          "!type": "fn(fd: number, callback?: fn(err: +Error, stats: +node.fs.Stats) -> ?) -> +node.fs.Stats",
        ...
        statSync: {
          "!type": "fn(path: string) -> +node.fs.Stats",
        ...
        fstatSync: {
          "!type": "fn(fd: number) -> +node.fs.Stats",
        ...
        watchFile: {
          "!type": "fn(filename: string, options: ?, listener: fn(current: +node.fs.Stats, prev: +node.fs.Stats))",
        ...
        watch: {
          "!type": "fn(filename: string, options?: ?, listener?: fn(event: string, filename: string)) -> +node.fs.FSWatcher",
      ...
      tls: {
        ...
        createServer: {
          "!type": "fn(options?: ?, connectionListener?: fn(stream: +node.tls.CleartextStream)) -> +node.tls.Server",
        ...
        connect: {
          "!type": "fn(port: number, host?: string, options: ?, listener: fn()) -> +node.tls.CleartextStream",
        ...
        createSecurePair: {
          "!type": "fn(credentials?: crypto.credentials, isServer?: bool, requestCert?: bool, rejectUnauthorized?: bool) -> +node.tls.SecurePair",
      ...
      crypto: {
        ...
        createHash: {
          "!type": "fn(algorithm: string) -> +node.crypto.Hash",
        ...
        createHmac: {
          "!type": "fn(algorithm: string, key: string) -> +node.crypto.Hmac",
        ...
        createCipher: {
          "!type": "fn(algorithm: string, password: string) -> +node.crypto.Cipher",
        ...
        createCipheriv: {
          "!type": "fn(algorithm: string, password: string, iv: string) -> +node.crypto.Cipher",
        ...
        createDecipher: {
          "!type": "fn(algorithm: string, password: string) -> +node.crypto.Decipher",
        ...
        createDecipheriv: {
          "!type": "fn(algorithm: string, key: string, iv: string) -> +node.crypto.Decipher",
        ...
        createSign: {
          "!type": "fn(algorithm: string) -> +node.crypto.Sign",
        ...
        createVerify: {
          "!type": "fn(algorith: string) -> +node.crypto.Verify",
        ...
        getDiffieHellman: {
          "!type": "fn(group_name: string) -> +node.crypto.DiffieHellman",
